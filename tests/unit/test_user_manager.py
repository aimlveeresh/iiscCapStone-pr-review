...
class TestHashPassword:
    def test_returns_hex_string(self):
        ...
        # bcrypt hash starts with $2b$ and is 60 characters long
    ...
    def test_same_input_produces_same_hash(self):
        ...
        # bcrypt hashes are salted, so two calls produce different hashes
        assert a != b
...
class TestExecuteSql:
    ...
    def test_constructs_query_with_user_input(self, mock_sqlite):
        ...
        executed_call = mock_cursor.execute.call_args
        executed_query = executed_call[0][0]
        executed_params = executed_call[0][1] if len(executed_call[0]) > 1 else None
